...
def build_graph(cfg):
    ...
    def preprocess_with_cfg(state):
        return preprocess_node(state, cfg)
    def agent_with_cfg(state):
        return agent_node(state, cfg)
    def instruct_with_cfg(state):
       return instructor_node(state, cfg)
    def should_continue_with_cfg(state):
